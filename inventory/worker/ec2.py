...
class Ec2Inventory(object):
    ...
    def read_settings(self):
        ...
        ec2.ini_path = os.environ.get('EC2_INI_PATH', defaults['ec2']['ini_path'])
        ec2.ini_path = os.path.expanduser(os.path.expandvars(ec2.ini_path))

        if not os.path.isfile(ec2.ini_path):
            ec2.ini_path = os.path.expanduser(defaults['ec2']['ini_fallback'])

        if os.path.isfile(ec2.ini_path):
            config.read(ec2.ini_path)
